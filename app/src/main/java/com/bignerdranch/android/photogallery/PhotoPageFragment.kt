...
// Чтобы добавить ProgressBar,
//WebView: WebChromeClient
//наслдник VisibleFragment
class PhotoPageFragment : VisibleFragment(){
    ...
    override fun onCreateView(
        ...
        //inflater присоединить  компоненты к корневому элементу
        ...
        webView.webChromeClient = object : WebChromeClient() {
            override fun
                    onProgressChanged(webView: WebView, newProgress: Int) {
                if (newProgress == 100) {
