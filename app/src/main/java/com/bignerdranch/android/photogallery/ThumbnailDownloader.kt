...
//Классу передается один обобщенный аргумент <T>.
//Пользователю ThumbnailDownloader понадобится объект для
...
//гибкой.
//Функция queueThumbnail() ожидает получить объект типа
//T, выполняющий функции идентификатора загрузки, и String
//с URL-адресом для загрузки. Эта функция будет вызываться
